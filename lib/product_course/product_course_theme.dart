...
class ProductCourseColors {
  static const Color background = Color(0xFF000000);
  static const Color surface = Color(0xFF0A0A0A);
  static const Color primary = Color(0xFF00FF88); // Neon Green
  static const Color accent = Color(0xFF00E676); // Slightly different green for accents
...
class ProductCourseFonts {
  ...
  static TextStyle body(double size, {Color? color, FontWeight? weight, double? height}) {
    return GoogleFonts.inter(
      fontSize: size,
      color: color ?? ProductCourseColors.textSecondary,
  ...
  static TextStyle mono(double size, {Color? color, FontWeight? weight, double? height}) {
    return GoogleFonts.jetBrainsMono(
      fontSize: size,
      color: color ?? ProductCourseColors.primary,
      fontWeight: weight ?? FontWeight.w400,
      height: height,
    );
  }
